...
from .utils import chunks, in_any, interv_to_range, get_sname
...
class SSPNetDataSampler:
    ...
    def df_from_file(self, wav_path, frame_sec):
        ...
        """
        data = LibrosaExtractor(frame_sec).extract_features_from_file(wav_path)
    ...
    def create_sampled_df(self, frame_sec, naudio=None, save_path=None, force_save=False):
        ...
        dataframes = [self.df_from_file(wav_path, frame_sec) for wav_path in tqdm(fullpaths)]
